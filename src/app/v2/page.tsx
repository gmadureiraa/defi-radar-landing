...
export default function V2Page() {
  ...
  return (
    <>
      ...
      <main>
        {/* ─── HERO (V2: Radar as standalone illustration) ──── */}
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center pt-28 pb-8">
            <motion.div
            ...
            <motion.p
              ...
              className="text-sm sm:text-base text-muted/80 max-w-2xl mx-auto mb-12 leading-relaxed"
            >
          ...
          {/* Radar Element — Standalone Illustration */}
          <motion.div
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[480px] h-[480px] sm:w-[550px] sm:h-[550px] rounded-full border border-green/10 animate-[pulse-ring_3s_ease-in-out_infinite]" />
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[520px] h-[520px] sm:w-[600px] sm:h-[600px] rounded-full border border-green/5 animate-[pulse-ring_3s_ease-in-out_1s_infinite]" />
            </div>
            ...
            {/* Radar image */}
            <img
              src="/radar-element-v2.png"
              alt="DeFi Radar"
              className="relative w-[350px] h-[350px] sm:w-[450px] sm:h-[450px] md:w-[500px] md:h-[500px] object-contain drop-shadow-[0_0_60px_rgba(34,197,94,0.2)]"
            />
          </motion.div>
          ...
          <motion.div
            ...
            className="relative z-10 flex flex-col items-center gap-6 pb-16"
          >
            <a
              href={APP_URL}
              target="_blank"
